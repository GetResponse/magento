var config = {
    map: {
        '*': {
            automation: "GetResponse_GetResponseIntegration/js/automation",
            createList: "GetResponse_GetResponseIntegration/js/createList",
            createRule: "GetResponse_GetResponseIntegration/js/createRule",
            customGrid: "GetResponse_GetResponseIntegration/js/customsGrid",
            ecommerce: "GetResponse_GetResponseIntegration/js/ecommerce",
            editRule: "GetResponse_GetResponseIntegration/js/editRule",
